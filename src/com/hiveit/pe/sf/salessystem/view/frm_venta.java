package com.hiveit.pe.sf.salessystem.view;
...
public class frm_venta extends javax.swing.JFrame {
    ...
    static ArrayList <c_detaventa> ventas = new ArrayList<c_detaventa>();
    ...
    public frm_venta() {
        ...
        jpFactura.add(btnBuscarCliente);
        ...
        try {
            ps = (PreparedStatement) cnn.prepareStatement("SELECT dni FROM empleado");
            ResultSet rs = ps.executeQuery();
            while (rs.next()){
            this.cmbempleado.addItem(rs.getString("dni"));
            }
        } catch (Exception e) {
        }	
    }
    ...
    private void initComponents() {
        ...
        btnBuscarCliente.setIcon(new ImageIcon(frm_venta.class.getResource("/img/edit_find.png")));
        btnBuscarCliente.setBounds(310, 55, 50, 40);
        jblFecha = new javax.swing.JLabel();
        jblFecha.setBounds(466, 30, 86, 14);
        jButton1 = new javax.swing.JButton();
        jButton1.setIcon(new ImageIcon(frm_venta.class.getResource("/img/plus.png")));
        ...
        brnAgregar.setIcon(new ImageIcon(frm_venta.class.getResource("/img/plus.png")));
        brnAgregar.setBounds(590, 105, 120, 40);
        btnGrabar = new javax.swing.JButton();
        btnGrabar.setIcon(new ImageIcon(frm_venta.class.getResource("/img/save.png")));
        btnGrabar.setBounds(192, 275, 100, 80);
        jButton3 = new javax.swing.JButton();
        jButton3.setIcon(new ImageIcon(frm_venta.class.getResource("/img/binoculars.png")));
        ...
        jpFactura.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de la Venta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        lblRegistrarVentas = new JLabel("Registrar Ventas");
        ...
        lblRegistrarVentas.setBounds(210, 2, 232, 35);
        ...
        jButton2.setIcon(new ImageIcon(frm_venta.class.getResource("/img/cancel2.png")));
        jButton2.setBounds(58, 275, 100, 80);
        jPanel4.add(jButton2);
                
                btnEliminar = new JButton("Eliminar");
                btnEliminar.setIcon(new ImageIcon(frm_venta.class.getResource("/img/gnome_edit_delete.png")));
    ...
    private void brnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brnAgregarActionPerformed
      ...
      double cantidad=0;  
        ...
        c_detaventa venta=new c_detaventa();
        ...
        try
        {
            ...
            { 
                ...
                venta.setNumcompro(txtnumventa.getText());
                venta.setCodarticulo(rs.getString("codarticulo"));
                venta.cantidad=cantidad;
                venta.setPvunt(rs.getDouble("pvunt"));
                venta.total=total(carrito.getCantidad(),carrito.getPvunt());
                ventas.add(venta);
    ...
    public void buscarCliente() {
        ...
        if (c != null) {
            ...
            txtbuscar.setText(String.valueOf(c.getDni()));
    ...
    private void btnBuscarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarClienteActionPerformed
    	...
    	if (txtbuscar.getText().compareTo("") != 0) {
            ...
            JOptionPane.showMessageDialog(null, "Ingrese número de documento del Cliente a Buscar");
            txtbuscar.requestFocus();
        }
    	deshabilitarCajas();    	     
   ...
   }else
   {
	  ...
	  if(rpta==JOptionPane.YES_OPTION){
	        ...
	        sqlventa = "INSERT INTO VENTAS(numcompro, tipocompro, dnicliente, dniempleado, fechaventa)"
	                + "VALUES(?, ?, ?, ?, ?)";
	        ...
	        for (c_detaventa y : ventas) {
	        	d_detaventa.insertarDetaVenta(y);
			}
    ...
    private String generarFactura() {	
    	...
    	Connection cnn = ConDB.getConnection();
        Statement st = cnn.createStatement();
        sqlnumfac = "select max(numcompro) from ventas";
