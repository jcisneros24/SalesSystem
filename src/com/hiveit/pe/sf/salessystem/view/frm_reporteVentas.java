...
public class frm_reporteVentas extends javax.swing.JFrame {	
    ...
    private void initComponents() {
        ...
        if (tableArticulo.getColumnModel().getColumnCount() > 0) {
        	tableArticulo.getColumnModel().getColumn(0).setHeaderValue("Num. Comprob.");
        	tableArticulo.getColumnModel().getColumn(1).setHeaderValue("Cliente");
        	tableArticulo.getColumnModel().getColumn(2).setHeaderValue("Empleado");
        	tableArticulo.getColumnModel().getColumn(3).setHeaderValue("Fech.Vent");
        	tableArticulo.getColumnModel().getColumn(4).setHeaderValue("Producto");
        	tableArticulo.getColumnModel().getColumn(5).setHeaderValue("P.Unt");
        	tableArticulo.getColumnModel().getColumn(6).setHeaderValue("Cantidad");
        	tableArticulo.getColumnModel().getColumn(7).setHeaderValue("Total");
        }
        ...
        btnNewButton.setIcon(new ImageIcon(frm_reporteVentas.class.getResource("/img/cancel2.png")));
        ...
        btnExportar.setIcon(new ImageIcon(frm_reporteVentas.class.getResource("/img/export_excel.png")));
    ...
    private String[] getColumnas(){
        String  columna[]=new String[]{"Num.Comprob.","Cliente","Empleado","fech.Venta","Producto","P.Unt","Cantidad","Total"};
        return columna;
    }      
    private void Filas(){
    try{
        for(c_reportes r : d_reportes.mostrarVentas()){
            String Datos[]={r.getNumcompro(),r.getApellidos(),String.valueOf(r.getDni()),String.valueOf(r.getFecha()),r.getDescripcion(),String.valueOf(r.getPvunt()),String.valueOf(r.getCantidad()),String.valueOf(r.getTotal())};
